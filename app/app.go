...
func NewOKExChainApp(
	...
	app.SetParallelTxHandlers(updateFeeCollectorHandler(app.BankKeeper, app.SupplyKeeper), evmTxFeeHandler(app.AccountKeeper), fixLogForParallelTxHandler(app.EvmKeeper))
